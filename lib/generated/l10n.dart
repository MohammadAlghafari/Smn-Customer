...
class S {
  ...
  String get should_be_more_than_7_letters {
    return Intl.message(
      'Should be more than 7 characters',
      name: 'should_be_more_than_7_letters',
      desc: '',
      args: [],
    );
  }
  ...
  /// `You can discover kitchens & fastfood arround you and choose you best meal after few minutes we prepare and delivere it for you`
  ...
  /// `You must add foods of the same kitchens choose one kitchens only!`
  ...
  /// `Reset your cart and order meals form this kitchen`
  ...
  /// `Keep your old meals of this kitchen`
  ...
  /// `Kitchens refreshed successfully`
  ...
  /// `The kitchen has been rated successfully`
  ...
  /// `Kitchens near to your current location`
  ...
  /// `Pickup your food from the kitchen`
  ...
  String get click_to_pay_on_delivery {
    return Intl.message(
      'Click to pay on delivery',
      name: 'click_to_pay_on_delivery',
      desc: '',
      args: [],
    );
  }
  ...
  /// `Delivery address outside the delivery range of this kitchens.`
  ...
  /// `This kitchen not support delivery method.`
  ...
  /// `Plaese choose Today or schedule`
  String get please_choose_Today_or_schedule {
    return Intl.message(
      'Plaese choose Today or schedule',
      name: 'please_choose_Today_or_schedule',
      desc: '',
      args: [],
    );
  }
  ...
  /// `please add delivery adress first`
  String get please_add_delivery_adress_first {
    return Intl.message(
      'please add delivery adress first',
      name: 'please_add_delivery_adress_first',
      desc: '',
      args: [],
    );
  }
  ...
  String get these_credentials_do_not_match_our_records {
    return Intl.message(
      'these credentials do not match our records',
      name: 'these_credentials_do_not_match_our_records',
      desc: '',
      args: [],
    );
  }
  ...
  String get please_choose_delivery_or_pickup {
    return Intl.message(
      'please choose delivery or pickup',
      name: 'please_choose_delivery_or_pickup',
      desc: '',
      args: [],
    );
  }
  ...
  String get please_enable_location_services {
    return Intl.message(
      'Please enable location services',
      name: 'please_enable_location_services',
      desc: '',
      args: [],
    );
  }
  ...
  String get email_or_phone_already_exist {
    return Intl.message(
      'email or phone already exist',
      name: 'email_or_phone_already_exist',
      desc: '',
      args: [],
    );
  }
  ...
  /// `Kitchen can not deliver to this delivery address please choose address that this kitchen cover...`
  String get kitchen_can_not_deliver_to_this_delivery_address {
    return Intl.message(
      'Kitchen can not deliver to this delivery address please choose address that this kitchen cover...',
      name: 'kitchen_can_not_deliver_to_this_delivery_address',
      desc: '',
      args: [],
    );
  }
