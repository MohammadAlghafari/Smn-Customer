...
import 'package:food_delivery_app/src/models/notification.dart' as not;
...
class _NotificationsWidgetState extends StateMVC<NotificationsWidget> {
  ...
  @override
  void initState() {
    List<not.Notification> notifications = _con.notifications
    ...
    return Scaffold(
      ...
      body: currentUser.value.apiToken == null
          ...
          : RefreshIndicator(
              ...
              child: _con.notifications
                      .where((element) => element.createdAt != DateTime(0)).toList()
                      .isEmpty
                  ...
                  : ListView(
                      ...
                      children: <Widget>[
                        ...
                        ListView.separated(
                          ...
                          shrinkWrap: true,
                          primary: false,
                          itemCount: _con.notifications
                              .where(
                                  (element) => element.createdAt != DateTime(0)).toList()
                              .length,
                          ...
                          itemBuilder: (context, index) {
                            return NotificationItemWidget(
                              notification: _con.notifications
                                  .where((element) =>
                                      element.createdAt != DateTime(0)).toList()
                                  .elementAt(index),
                              onMarkAsRead: () {
                                _con.doMarkAsReadNotifications(
                                    _con.notifications.toList().elementAt(index));
                              },
                              onMarkAsUnRead: () {
