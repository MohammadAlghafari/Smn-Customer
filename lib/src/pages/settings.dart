...
import 'package:food_delivery_app/src/elements/ProfileNumberSettingsDialog.dart';
                      ...
                      child: ListView(
                        ...
                        children: <Widget>[
                          ...
                          ListTile(
                            ...
                            trailing: Text(
                              setting.value.mobileLanguage.value.languageCode == 'en' ?  S.of(context).english : S.of(context).arabic,
                              style: TextStyle(
                                  color: Theme.of(context).focusColor),
                            ),
                          ),
