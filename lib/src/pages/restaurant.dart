                            ...
                            children: [
                              ...
                              Padding(
                                ...
                                child: Row(
                                  children: [
                                    Text(
                                      S.of(context).avg_preparing_time,
                                      style: TextStyle(
                                          fontSize: 16,
                                          fontWeight: FontWeight.bold),
                                    ),
                                    Text(
                                      _con.restaurant.avgTime +
                                          ' ' +
                                          S.of(context).hrs,
                                    ...
                                    SizedBox(
                                      ...
                                      child: FlatButton(
                                        ...
                                        disabledColor: Theme.of(context)
                                            .focusColor
                                            .withOpacity(0.5),
                                        onPressed: currentUser.value.apiToken !=
                                                null
                                            ? () async {
                                                List<String> chatOwners = [];
                                                for (int i = 0;
                                                    i <
                                                        _con.restaurant.users
                                                            .length;
                                                    i++)
                                                  chatOwners.add(_con
                                                      .restaurant.users[i].id);
                                                ;
                                                chatOwners
                                                    .add(currentUser.value.id);
                                                List<User> users = _con
                                                    .restaurant.users
                                                    .map((e) {
                                                  e.image =
                                  ...
                                  children: <Widget>[
                                    ...
                                    SizedBox(
                                      ...
                                      child: FlatButton(
                                        padding: EdgeInsets.all(0),
                                        onPressed: () {
                                          if (_con.restaurant.mobile != null)
                                            launch(
